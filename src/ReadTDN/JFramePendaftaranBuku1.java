...
public class JFramePendaftaranBuku1 extends Master {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        try {
            cbKategori.removeAllItems(); //Tindakan ini dilakukan untuk membersihkan JComboBox sebelum menambahkan item baru.
            while (rs.next()) {
                ...
                cbKategori.addItem(kategori);//Baris ini menambahkan nilai kategori ke dalam JComboBox cbKategori sebagai item baru.
            }
        } catch (Exception e) {
        }
